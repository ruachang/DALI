...
os.environ['MASTER_ADDR'] = '222.200.163.219'
os.environ['MASTER_PORT'] = '1862'
os.environ['RANK'] = '0'
...
def parse():
    ...
    parser.add_argument('data', default = "/home/developers/liuchang/FER", metavar='DIR', nargs='*',
...
# * 继承修饰器, 设置读入的管道
@pipeline_def
def create_dali_pipeline(data_dir, txt_dir, crop, size, shard_id, num_shards, dali_cpu=False, is_training=True):
...
def main():
    ...
    if(args.arch == "inception_v3"):
        ...
        crop_size = 224
        val_size = 256
    traindir = "/home/developers/liuchang/FER数据集"
    valdir = "/home/developers/liuchang/FER数据集"
    train_txt_path = "/home/developers/liuchang/FER数据集/Oulu-CASIA/NI200cropped/10_fold_txt/0_10_fold_train.txt".format(10)
    val_txt_path = txt_path = "/home/developers/liuchang/FER数据集/Oulu-CASIA/NI200cropped/10_fold_txt/0_10_fold_val.txt".format(10)
    # * 初始化读入的管道
